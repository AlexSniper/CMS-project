                ...
                <!-- Page Heading -->
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            ...
                            Your status is  <small> <?php echo $_SESSION['user_role']; ?></small>  
                        </h1>
...
<div class="row">
	...
	$count_suscribers  = mysqli_num_rows($select_all_subscribers);	
			
						
						
					 $all_other_posts = $post_counts - ($post_published_counts + $post_draft_counts);
	...
	$element_text = ['All Posts','Active Posts', 'Draft Posts','Other Posts','Comments', 'Unapproved Comments','Users' ,   'Subscribers', 'Categories'];
    $element_count = [ $post_counts, $post_published_counts,  $post_draft_counts, $all_other_posts,$comments_counts, $count_unapproved_comments,  $users_counts, $count_suscribers, $categories_count];
